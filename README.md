...
It automatically checks the comments and usernames of comments using the google API and uses pre defined keywords + multiple AIs trained to find and delete the bot comments.
